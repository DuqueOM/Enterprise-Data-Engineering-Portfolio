...
def main():
    ...
    parser.add_argument("--input_file", type=str, required=True, help="Text file with baseline texts")
    parser.add_argument("--output_file", type=str, default="baseline_emb.pkl", help="Output pickle file")
